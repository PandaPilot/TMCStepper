...
class TMC2208Stepper : public TMCStepper {
	public:
	    TMC2208Stepper(uart_inst_t * SerialPort, float RS, uint8_t addr, uint16_t mul_pin1, uint16_t mul_pin2);
		TMC2208Stepper(uart_inst_t * SerialPort, float RS) :
	...
	protected:
		...
		TMC2208Stepper(uart_inst_t * SerialPort, float RS, uint8_t addr);
		#if SW_CAPABLE_PLATFORM
			TMC2208Stepper(uint16_t SW_RX_pin, uint16_t SW_TX_pin, float RS, uint8_t addr);
		#endif

		uart_inst_t * HWSerial = nullptr;
...
class TMC2209Stepper : public TMC2208Stepper {
	public:
		TMC2209Stepper(uart_inst_t * SerialPort, float RS, uint8_t addr) :
